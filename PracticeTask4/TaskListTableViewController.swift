...
class TaskListTableViewController: UITableViewController {
    ...
    // MARK: - Table view data source
        ...
        // #warning Incomplete implementation, return the number of rows
            return TaskController.sharedController.incompleteTask.count
    }
        ...
        if segue.identifier == "toDetailView" {
            ...
            if let taskDetailTableViewController = destinationViewController{
                ...
                if let selectedRow = tableView.indexPathForSelectedRow?.row {
                    taskDetailTableViewController.updateWithTask(TaskController.sharedController.incompleteTask[selectedRow])
                }
            }
